...
const GiftModal: React.FC<GiftModalProps> = ({ isOpen, onClose, userDiamonds, onSendGift, onRecharge, gifts, receivedGifts, isBroadcaster = false, isSendingGift = false, isVIP, onOpenVIPCenter }) => {
    ...
    const maxCanSend = useMemo(() => {
        ...
        return Math.floor((userDiamonds || 0) / selectedGift.price);
    ...
    const handleSend = () => {
        ...
        if (quantity > 0 && quantity * (selectedGift.price || 0) <= (userDiamonds || 0)) {
                    ...
                    <div className="flex justify-between items-center mb-2 relative text-center h-9">
                        ...
                        <div className="absolute right-0 top-1/2 -translate-y-1/2">
                            <div className="flex items-center space-x-2 bg-[#2C2C2E] p-1.5 rounded-full">
                                ...
                                <span className="text-white font-semibold text-sm">{(userDiamonds || 0).toLocaleString('pt-BR')}</span>
