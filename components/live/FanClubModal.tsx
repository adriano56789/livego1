...
const FanClubModal: React.FC<FanClubModalProps> = ({ 
    isOpen, onClose, streamer, isMember, currentUser, onConfirmJoin 
}) => {
                         ...
                         <div className="flex items-center justify-between w-full">
                             <div className="flex items-center gap-3">
                                 ...
                                 <div className="flex flex-col">
                                     <span className="text-white font-bold text-[13px]">1755 Pontos de Lealdade</span>
                                     <span className="text-gray-500 text-[10px] leading-tight">1000 Pontos de Lealdade são necessários.</span>
                                 </div>
                             </div>
