...
const FooterNav: React.FC<FooterNavProps> = ({ onOpenGoLive, activeTab, onNavigate }) => {
  const { t } = useTranslation();

  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#121212] border-t border-white/5 h-[70px] flex items-end justify-between px-2 z-40 pb-2">
